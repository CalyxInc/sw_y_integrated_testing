    ...
    while True:    
        ...
        if sen == "X":      
            if send == b'E\x00\x01\x13Y':
                ...
                if x_temp != None and x_humi != None:
                    probe_flag.value = 1
            ...
            if send == b'E\x00\x01\xca\x10':
                ...
                x_ammo = ammonia
                if x_ammo != None and probe_flag.value == 1:
                    probe_flag.value = 2
...
def check_gatewayData(send):
    ...
    if(at_cmd_cksum(send) == 'OK'):
        ...
        if(payload_hex[0] == 1): # Regular measurement package (Y gen1)
            ...
            print("gateway:", "Rssi:", rssi, "Battery:", battery)
